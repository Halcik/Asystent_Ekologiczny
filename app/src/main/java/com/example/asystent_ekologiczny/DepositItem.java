...
public class DepositItem {
    ...
    public DepositItem(long id, String category, String name, double value, String barcode) {
        this.id = id;
    ...
    public DepositItem(String category, String name, double value, String barcode) { this(-1, category, name, value, barcode); }
